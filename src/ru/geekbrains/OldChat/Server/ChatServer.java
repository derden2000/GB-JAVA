package ru.geekbrains.OldChat.Server;

import ru.geekbrains.OldChat.Client.AuthException;
import ru.geekbrains.OldChat.Client.TextMessage;
import ru.geekbrains.OldChat.Server.auth.AuthService;
import ru.geekbrains.OldChat.Server.auth.AuthServiceImpl;
...
import static ru.geekbrains.OldChat.Client.MessagePatterns.AUTH_FAIL_RESPONSE;
import static ru.geekbrains.OldChat.Client.MessagePatterns.AUTH_SUCCESS_RESPONSE;
